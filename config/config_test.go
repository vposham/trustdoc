...
func TestGetAll(t *testing.T) {
	...
	t.Run("GetAllSuccess", func(t *testing.T) {
		...
		assert.NoError(t, Load(context.Background(), "../../resources"))
...
func TestGetProps(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			p, _ := load(context.TODO(), tt.args.resourceDir)
...
func TestGetPropsArr(t *testing.T) {
	...
	p, _ := load(context.TODO(), "./testData")
	arrKey := "sample.prop3"
...
func TestGetSecretFromEnv(t *testing.T) {
	...
	t.Setenv("DOC_DB_SOURCE_URL", expected)
