// Package reqlogger provides 3 middlewares.
// 1 - to mark business interested endpoints
// 2 - to inject a new request id for every request
// 3 - to inject a new logger with request id for every request
package reqlogger
...
const (
	...
	// from the header and use it for correlation or else we generate a new id per request
