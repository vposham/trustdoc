...
//0x0100000000000000020000000000000048D61100
...
//
// Solidity: event DocumentMinted(uint256 indexed tokenId, string docId, string docMd5Hash, string ownerEmailIdMd5Hash, uint256 uploadedAt)
