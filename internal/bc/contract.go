...
func (k *Etherium) InstallContract(ctx context.Context) (*common.Address, error) {
...
func (k *Etherium) sendAndWaitForMining(ctx context.Context, tx *types.Transaction) (*txnReceipt, error) {
...
func (k *Etherium) signAndSendTxn(ctx context.Context, tx *types.Transaction) (string, error) {
...
func (k *Etherium) waitUntilMined(ctx context.Context, start time.Time, txHash string,
...
func (k *Etherium) rpcCall(ctx context.Context, result interface{}, method string, args ...interface{}) error {
...
func (k *Etherium) generateTransaction(nonce uint64) *types.Transaction {
	tx := types.NewTx(&types.LegacyTx{
		Nonce:    nonce,
		GasPrice: k.gasPrice,
		Gas:      uint64(k.gasLimitOnTx),
